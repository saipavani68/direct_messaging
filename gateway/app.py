...
def authenticateUser(username, password):
    ...
    if result:
        ...
        validate_user = check_password_hash(hashed_password, password)
        app.logger.info(validate_user) #checking if user entered password is equal to the hashed password in db
        if validate_user:
